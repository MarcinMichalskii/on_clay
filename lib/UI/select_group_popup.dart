...
class SelectClubsGroup extends HookWidget {
  final ClubsGroup selectedGroup;
  final List<ClubData> clubs;
  final ValueSetter<ClubsGroup> onGroupSelected;
  final List<ClubsGroup> groupsList;
  final ValueSetter<List<ClubsGroup>> onGroupsListChanged;
  ...
  SelectClubsGroup(
      ...
      required this.onGroupsListChanged});
